...
def register_default_types():
    ...
    from .show import ShowOptionItem
    ...
    OptionItemRegistry.register("show", ShowOptionItem)

    logger.debug("\u5df2\u6ce8\u518c\u9ed8\u8ba4\u9009\u9879\u7c7b\u578b: combobox, select, switch, input, inputs, lineedit, checkbox, show")
